    ...
    <section class="space-y-9">
        <div class="space-y-9 print">
            <div
                ...
                @endif
                <p class="text-min sm:text-base leading-6 text-center py-3">
                    @if($fastPayment->financeTransaction->payment->state!='finished')
        ...
        <div class="flex items-center justify-between  ">
            ...
            <div
                class="@if($fastPayment->financeTransaction->payment->state=='finished') bg-green-500  @else bg-rose-500 @endif py-3  rounded-md font-semibold w-full flex items-center justify-center cursor-pointer space-x-reverse space-x-2">
                    <p>درحال بازگشت به سایت پذیرنده</p>
                    <div role="status">
