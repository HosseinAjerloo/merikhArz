...
<script>
    ...
    let showError = (message) => {
        const errorMessage = ` <section class="container p-2 absolute space-y-2 max-w-max z-[1000]">
        ...
        document.getElementById('errorBox').insertAdjacentHTML('afterbegin', errorMessage)
        let toast = $('.toast');
        setTimeout(function () {
